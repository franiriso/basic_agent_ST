...
## Generated on : Wed Oct 22 10:53:41 2025
...
START_DIR                 = /Users/franiriso/Documents/UNITN/1S/Intelligent\ Vehicles\ and\ Autonomous\ Driving/IVAD/basic_agent_st/matlab
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
rt_nonfinite.o : $(START_DIR)/codegen/lib/primitives/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/primitives/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/primitives/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


primitives.o : $(START_DIR)/codegen/lib/primitives/primitives.c
	$(CC) $(CFLAGS) -o "$@" "$<"
